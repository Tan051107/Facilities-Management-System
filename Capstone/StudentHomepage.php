<?php
    ...
    $query1 = "SELECT * FROM student_details WHERE StudentID = ?";
...
<body class="lightmode homepage">
        ...
        <div class="function">
            <div class="quickaccess">
                ...
                <div class="quickbut">
                    ...
                    <a href="submitFeedback.php">Feedback</a>
                    <a href="StudentTimetable.php">View Timetable</a>
                    <a href="Library.php">Library</a>
                </div>
            </div>
    ...
    <script src="StudentHomePage.js?v=<?php echo time(); ?>"></script>
